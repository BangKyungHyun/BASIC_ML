...
# Mean Square Error Loss 를 함수를 이용하여 구현
def mse(x_hat, x):
...
# PyTorch에서 사전 구현된 손실 함수(loss function)를 함수를 이용하여 구현
# Predefined MSE in PyTorch
import torch.nn.functional as F

# reduction parameter의 default 값은 'mean', 즉 정답과 예측값의 cross entropy를 한 후 나온 값들의
# 평균을 내서 return
F.mse_loss(x_hat,x)
...
# reduction = 'none'을 해주게 되면 평균을 return 해주는 것이 아닌 모든 pixel 의 cross entropy 결과 값을
# return
